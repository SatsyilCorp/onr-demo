...
with tab1:
    ...
    st.dataframe(
        [
            ...
            {"resource": "job", "name": "onr-demo-grants-file-arrival", "state": "paused · file arrival · onr demo cluster"},
            {"resource": "job", "name": "onr-demo-score-registered-models", "state": "manual · onr demo ml"},
...
with tab3:
    ...
    st.caption(f"Source · {label} · project repository")
    dab_candidates = [
